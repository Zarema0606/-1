...
class Window(customtkinter.CTk):
    ...
    def start_scraping(self):
        ...
        if not url:
            ...
            logger.info("https://www.avito.ru/moskva_i_mo/kvartiry/prodam-ASgBAgICAUSSA8YQ?cd=1&context=H4sIAAAAAAAA_0q0MrSqLraysFJKK8rPDUhMT1WyLrYysVLKTczMU7KuBQQAAP__w5qblCAAAAA")
            return
        """Прячем кнопку старт"""
        self.is_run = True
        self.switch_action()
